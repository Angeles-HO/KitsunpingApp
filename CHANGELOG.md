...
- Added persistent ONNX runtime controls for enablement, learning, and the bundled model.

### Improved

- Moved privileged command execution and boolean property persistence into dedicated root helpers.
- Updated launcher assets across supported density buckets.

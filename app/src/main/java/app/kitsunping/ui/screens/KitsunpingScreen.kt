...
fun KitsunpingApp(
    ...
    onnxEnabled: Boolean = true,
    onRequestOnnxEnabled: (Boolean) -> Unit = {},
    onnxLearningEnabled: Boolean = true,
    onRequestOnnxLearningEnabled: (Boolean) -> Unit = {},
    onnxUseDefaultModel: Boolean = true,
        ...
        Box(
            ...
            when (tab) {
                ...
                MainTab.SETTINGS -> SettingsScreen(
                    ...
                    onRequestOnnxEnabled = onRequestOnnxEnabled,
                    onRequestOnnxLearningEnabled = onRequestOnnxLearningEnabled,
                    onRequestOnnxUseDefaultModel = onRequestOnnxUseDefaultModel,
